<template>
  <header>
    <div class="left">
      <router-link :to="{name:'Home'}" href class="btn btn-icon">
    ...
    <router-link :to="{name:'Home'}" href="/" class="logo"></router-link>
    <div class="right">
...
export default {
  ...
  data() {
    return {
      menuItems: [{ name: "Logout", command: "logout" }, { seperator: true }]
    };
  },
  computed:{
      ...mapState('user',{
