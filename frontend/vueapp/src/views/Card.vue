      ...
      <div class="popup-header">
        <div class="popup-title">
          ...
          <div class="popup-title-text">
            <textarea class="form-field-input" ref="cardNameInput" @blur="editCardName">{{card.name}}</textarea>
          </div>
        ...
        <div class="window-module">
          <div class="title">
            ...
            <div class="title-text">
              <h3>描述</h3>
              <button class="btn btn-edit" @click="$refs.cardDescriptionInput.focus()">编辑</button>
            </div>
          </div>

          <p class="description">
            <textarea class="form-field-input" ref="cardDescriptionInput" @blur="editCardDescription">{{card.description}}</textarea>
          </p>
        </div>
...
export default {
  ...
  methods: {
    editCardDescription() {
        let {value} = this.$refs.cardDescriptionInput;
        console.log(value)
        this.$store.dispatch('card/editCard', {
            id: this.card.id,
            description: value
        })
        this.$message.success('Description Changed Successfully')

    },
    editCardName() {
        let {value} = this.$refs.cardNameInput;
        this.$store.dispatch('card/editCard', {
            id: this.card.id,
            name:value,
        })
        this.$message.success('Name Changed Successfully')
    }
  }
};
</script>