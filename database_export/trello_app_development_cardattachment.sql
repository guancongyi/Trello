...
--
-- Table structure for table `cardattachment`
--
...
--
-- Dumping data for table `cardattachment`
--

LOCK TABLES `cardattachment` WRITE;
/*!40000 ALTER TABLE `cardattachment` DISABLE KEYS */;
/*!40000 ALTER TABLE `cardattachment` ENABLE KEYS */;
UNLOCK TABLES;
