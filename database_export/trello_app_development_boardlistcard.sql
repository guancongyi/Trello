...
--
-- Table structure for table `boardlistcard`
--
...
--
-- Dumping data for table `boardlistcard`
--

LOCK TABLES `boardlistcard` WRITE;
/*!40000 ALTER TABLE `boardlistcard` DISABLE KEYS */;
/*!40000 ALTER TABLE `boardlistcard` ENABLE KEYS */;
UNLOCK TABLES;
